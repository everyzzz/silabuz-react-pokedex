	...
	return (
		<div className="pokedex">
			...
			<div className='btn-content'>
				<button id='btn-login-menu' onClick={signInWithGitHub}>Log In</button>
				<button id='btn-logout-menu' onClick={signout}>Log Out</button>
				{loged ? <button id='btn-favs-menu' onClick={getFav}>Mis favoritos</button> : null}
			</div>
		</div>
